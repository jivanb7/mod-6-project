...
Revision ID: 9cd291d1a1ac
Revises: 
Create Date: 2024-11-15 09:39:11.788937
...
def upgrade():
    # Determine which dialect is in use and set schema
    conn: Connection = op.get_bind()
    schema = 'flask_schema' if conn.dialect.name == "postgresql" else None

    # Create schema only for PostgreSQL
